...
GPIO.setup(5, GPIO.OUT) # set up pin 11
GPIO.setup(6, GPIO.OUT) # set up pin 11
GPIO.setup(11, GPIO.OUT) # set up pin 11
GPIO.setup(13, GPIO.OUT) # Set up pin 13
GPIO.setup(15, GPIO.OUT) # Set up pin 15
GPIO.setup(16, GPIO.OUT) # Set up pin 15
GPIO.setup(18, GPIO.OUT) # Set up pint 18
